...
# SNA Course Lab Journal
Last compiled on `r format(Sys.time(), '%B, %Y')`  

*I see things in the computer screen, troublesome things. First attempt at logging research on a website, seems very useful. If someone asks me what I did exactly I can tell them to google it!*
...
Sharing our work openly with our colleagues is good for science, as long as we credit each other. Merton said that, I think [@Merton]. 

Everyone can fork this repository. Use this example to journal your lab work and assignments. 

The creators of this lab journal template, Jochem Tolsma and Bas Hofstra, use this repository for their Social Network Analysis For Social Scientists course [@SNASS]. <!--- this is a reference, stored in references.bib. It will be automatically added at the bottom of the page --->
